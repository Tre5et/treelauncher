...
public class LauncherImage extends WritableImage {
    public LauncherImage(BufferedImage img) {
        super(getPixelBuffer(img));
    }

    public LauncherImage(Image base, Image top) {
        super((int)base.getWidth(), (int)base.getHeight());
    ...
    public Image getScaled(int scaleFactor) {
    ...
    private static PixelBuffer<IntBuffer> getPixelBuffer(BufferedImage img){
        ...
        return new PixelBuffer<>(newImg.getWidth(), newImg.getHeight(), buffer, pixelFormat);
    }
}
