    ...
    selector = Selector(
        ...
        instance = Selector.Instance(
            ...
            game = Selector.Instance.Game(
                cleanupFailCancel = { "Cancel; launcher will be unusable" },
                cleanupFailMessage = { "The game files were unable to be moved to their destination.\nMake sure to close any game related folders and files before retrying.\nIf you cancel this, the launcher will not be function afterwards." },
                cleanupFailRetry = { "Retry" },
                cleanupFailTitle = { "Resource cleanup failed!" },
