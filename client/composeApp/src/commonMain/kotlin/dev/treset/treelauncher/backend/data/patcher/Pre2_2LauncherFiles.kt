...
open class Pre2_2LauncherFiles {
    ...
    val instanceComponents = mutableStateListOf<Pre2_2InstanceComponent>()
    ...
    val versionComponents = mutableStateListOf<Pre2_2VersionComponent>()
