                ...
                new PopupElement(
                        ...
                        List.of(
                                ...
                                new PopupElement.PopupButton(
                                        ...
                                        event -> UiUtil.openFolder(FormatUtil.absoluteDirPath(gameLauncher.getInstance().getInstance().getKey().getDirectory(), LauncherApplication.config.INCLUDED_FILES_DIR, "crash-reports"))
                                )
                        )
                )
        );
